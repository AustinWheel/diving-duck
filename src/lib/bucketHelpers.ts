...
export function calculateBucketId(projectId: string, timestamp: Date, bucketMinutes: number): string {
...
export function calculateBucketTimes(timestamp: Date, bucketMinutes: number): { start: Date; end: Date } {
  const date = new Date(timestamp);
...
export function calculateBucketRange(projectId: string, startTime: Date, endTime: Date, bucketMinutes: number): string[] {
