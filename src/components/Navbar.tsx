    ...
    >
      <Flex
        ...
        style={{
          ...
          borderRadius: "16px",
          backdropFilter:
            isScrolled || !isHome ? "blur(20px) saturate(180%)" : "blur(10px) saturate(180%)",
      ...
      >
        <Flex fillWidth height="64" horizontal="space-between" vertical="center" paddingX="xl">
          {/* Logo */}
          <Flex
            href="/"
            gap="s"
          ...
          <Flex gap="s" vertical="center">
            {user ? (
              <>
                <Button
                  href="/dashboard"
                  variant={isDashboard ? "secondary" : "primary"}
                  size="s"
                  hide="s"
                >
                  Dashboard
