        ...
        <Column maxWidth="m" style={{ margin: "0 auto" }} gap="l">
          ...
          <Flex direction="column" gap="m">
            ...
            <Text variant="body-default-m">
              ...
              parties. This does not include trusted partners who assist us in operating our
              service, as long as those parties agree to keep this information confidential.
            </Text>
          </Flex>
          ...
          <Flex direction="column" gap="m">
            ...
            <Text variant="body-default-m">
              ...
              alteration, disclosure, or destruction of your personal information and data stored on
              our service.
            </Text>
          </Flex>
          ...
          <Flex direction="column" gap="m">
            ...
            <Text variant="body-default-m">
              ...
              this by logging into your account settings or contacting us directly.
            </Text>
          </Flex>
          ...
          <Flex direction="column" gap="m">
            ...
            <Text variant="body-default-m">
              We use cookies to enhance your experience, gather general visitor information, and
              track visits to our website. You can choose to disable cookies through your browser
              settings.
            </Text>
          </Flex>
